...
import jpoker.poker.evaluator.HandEvaluator;
...
public class Hand /*implements Cloneable*/
{
  ...
  public int _cards[];
  public int _cardsDelt;
  public int _intval;
  public int _card_hash[];
  public int _rankbits;
  public int _suithash;		// need at least  4 suits * 4 bits = 16 bits
  public long _Rankhash;		// need at least 13 ranks * 4 bits = 52 bits 
  ...
  public Hand (String s)
  {
	...
	for (int i=0; i<str.length(); i+=2)
      ...
      */
    String[] str=StringUtilities.stringToWords(s);
